...
})({"6Cziv":[function(require,module,exports) {
...
var _todoDom = require("./todoDom");
var _todoEventHandlers = require("./todoEventHandlers");
var _todoControls = require("./todoControls");
var _todoDomUtils = require("./todoDomUtils");
var _notyfMinCss = require("notyf/notyf.min.css");
var _storage = require("./storage");
var _todoFilter = require("./todoFilter");
// Initialize state with localstorage
(0, _storage.initializeStorage)();
// Initialize dark or light mode of website
(0, _todoDom.initializeDarkMode)();
...
(0, _todoFilter.renderTodosByFilter)(state.appliedFilter, true);
// Adjust the height of the list for the sake of smooth animation
// throughout the app
(0, _todoDomUtils.adjustListHeight)();
// Run list animation when all DOM content is rendered
document.addEventListener("DOMContentLoaded", (0, _todoDomUtils.animateInitialTodoLoad));
// Handle all todo related events
(0, _todoDom.todoListElement).addEventListener("click", (0, _todoEventHandlers.handleTodoClick));
// Handle all form related events
(0, _todoDom.todoFormElement).addEventListener("submit", (0, _todoEventHandlers.handleFormSubmit));
// Initialize and handle all filter events
(0, _todoControls.initializeControls)();

},{"./todoDom":"l3eyk","./todoEventHandlers":"knUSZ","./todoControls":"bNdHE","./todoDomUtils":"5iDqy","notyf/notyf.min.css":"bpCRw","./storage":"g091k","./todoFilter":"8XoUO"}],"l3eyk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "todoListElement", ()=>todoListElement);
parcelHelpers.export(exports, "todoFormElement", ()=>todoFormElement);
parcelHelpers.export(exports, "todoInputElement", ()=>todoInputElement);
parcelHelpers.export(exports, "allButtonElement", ()=>allButtonElement);
parcelHelpers.export(exports, "activeButtonElement", ()=>activeButtonElement);
parcelHelpers.export(exports, "completedButtonElement", ()=>completedButtonElement);
parcelHelpers.export(exports, "controlButtons", ()=>controlButtons);
parcelHelpers.export(exports, "todoCountNumberElement", ()=>todoCountNumberElement);
parcelHelpers.export(exports, "todoCountTextElement", ()=>todoCountTextElement);
parcelHelpers.export(exports, "clearButtonElement", ()=>clearButtonElement);
parcelHelpers.export(exports, "dragTextInfoElement", ()=>dragTextInfoElement);
parcelHelpers.export(exports, "darkModeBtnElement", ()=>darkModeBtnElement);
parcelHelpers.export(exports, "darkModeBtnImage", ()=>darkModeBtnImage);
parcelHelpers.export(exports, "renderTodos", ()=>renderTodos);
parcelHelpers.export(exports, "sortable", ()=>sortable);
parcelHelpers.export(exports, "initializeDarkMode", ()=>initializeDarkMode);
var _todoDomUtils = require("./todoDomUtils");
...
const todoInputElement = document.querySelector(".todo__input");
const allButtonElement = document.querySelector("#todo__controls-btn-all");
const activeButtonElement = document.querySelector("#todo__controls-btn-active");
const completedButtonElement = document.querySelector("#todo__controls-btn-completed");
const controlButtons = document.querySelectorAll(".todo__controls-btn");
const todoCountNumberElement = document.querySelector(".todo__count-number");
const todoCountTextElement = document.querySelector(".todo__count-text");
const clearButtonElement = document.querySelector("#todo__controls-btn-clear");
const dragTextInfoElement = document.querySelector(".todo__text-info");
const darkModeBtnElement = document.querySelector(".darkmode-btn");
const darkModeBtnImage = document.querySelector(".img-darkmode");
const renderTodos = function() {
    (0, _todoDomUtils.addMissingTodos)(true);
    (0, _todoDomUtils.countTodos)();
};
const sortable = new (0, _sortablejsDefault.default)(todoListElement, {
    dataIdAttr: "data-id",
    animation: 150,
    onEnd: function() {
        const state = (0, _storage.getState)();
        ...
        const newTodos = state.todos.map((todo)=>{
            const todoElement = allListElements.find((el)=>el.dataset.originalId === todo.originalId);
            if (todoElement) {
        ...
        (0, _storage.updateTodoState)(newTodos);
    }
});
darkModeBtnElement.addEventListener("click", function() {
    ...
    darkModeBtnImage.src = darkMode ? (0, _iconMoonSvgDefault.default) : (0, _iconSunSvgDefault.default);
    darkModeBtnElement.setAttribute("aria-pressed", !state.darkMode);
    (0, _storage.updateDarkMode)(!darkMode);
});
const initializeDarkMode = function() {
    const state = (0, _storage.getState)();
    document.body.classList.add(state.darkMode ? "dark" : "light");
    document.body.classList.remove(state.darkMode ? "light" : "dark");
    darkModeBtnImage.src = state.darkMode ? (0, _iconSunSvgDefault.default) : (0, _iconMoonSvgDefault.default);
    darkModeBtnElement.setAttribute("aria-pressed", state.darkMode);
};

},{"./todoDomUtils":"5iDqy","sortablejs":"4mik1","./storage":"g091k","../images/icon-sun.svg":"6xyKm","../images/icon-moon.svg":"5qRnu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5iDqy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createTodoElement", ()=>createTodoElement);
parcelHelpers.export(exports, "countTodos", ()=>countTodos);
parcelHelpers.export(exports, "removeTodoElements", ()=>removeTodoElements);
parcelHelpers.export(exports, "addMissingTodos", ()=>addMissingTodos);
parcelHelpers.export(exports, "adjustListHeight", ()=>adjustListHeight);
parcelHelpers.export(exports, "animateInitialTodoLoad", ()=>animateInitialTodoLoad);
parcelHelpers.export(exports, "removeButtonsActive", ()=>removeButtonsActive);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
var _todoDom = require("./todoDom");
var _storage = require("./storage");
var _iconCrossSvg = require("../images/icon-cross.svg");
var _iconCrossSvgDefault = parcelHelpers.interopDefault(_iconCrossSvg);
const createTodoElement = function(todo, initialRender = false) {
    const newTodoElement = document.createElement("li");
    newTodoElement.classList.add("todo__item", "card");
    if (todo.status === "completed") newTodoElement.classList.add("todo__item--done");
    ...
    newTodoElement.innerHTML = `        
      <input ${todo.status === "completed" ? "checked" : ""} aria-label="Mark todo as done" aria-labeledby="tododescription-${todo.originalId}" type="checkbox" class="checkboxcircle todo__checkbox ignore-dragging" />
          <span class="todo__description-wrapper par"><span id="tododescription-${todo.originalId}" class="todo__description">${todo.description}</span></span>
          <button class="btn todo__btn-delete ignore-dragging" aria-label="Delete todo">
            <img alt="cross sign for deleting todo" class="img" src="${0, _iconCrossSvgDefault.default}"/>
            </button>
              `;
    if (!initialRender) (0, _gsapDefault.default).fromTo(newTodoElement, {
        opacity: 0,
        y: -20
    }, {
        opacity: 1,
...
const countTodos = function() {
    const todoCount = document.querySelectorAll(".todo__item[data-status='active']").length;
    if (todoCount > 1) {
        (0, _todoDom.todoCountNumberElement).textContent = todoCount;
        (0, _todoDom.todoCountTextElement).textContent = "items";
    } else if (todoCount === 1) {
        (0, _todoDom.todoCountNumberElement).textContent = todoCount;
        (0, _todoDom.todoCountTextElement).textContent = "item";
    } else {
        (0, _todoDom.todoCountNumberElement).textContent = "No";
        (0, _todoDom.todoCountTextElement).textContent = "item";
    }
};
const removeTodoElements = function(todoElements) {
    if (Array.isArray(todoElements)) {
        todoElements.forEach((el)=>(0, _todoDom.todoListElement).removeChild(el));
        countTodos();
        return adjustListHeight();
    }
    (0, _gsapDefault.default).to(todoElements, {
        opacity: 0,
        y: -20,
        onComplete: ()=>{
            (0, _todoDom.todoListElement).removeChild(todoElements);
            countTodos();
            adjustListHeight();
        },
        duration: 0.15,
...
const addMissingTodos = function(initialRender = false) {
    const state = (0, _storage.getState)();
    let missingTodos = [];
    const filter = state.appliedFilter;
    const existingIds = Array.from((0, _todoDom.todoListElement).children).map((el)=>el.dataset.originalId);
    missingTodos = state.todos.filter((el)=>{
        return !existingIds.includes(el.originalId);
    });
    if (initialRender) missingTodos = state.todos.filter((el)=>{
        if (filter === "all") return true;
        else if (filter === "active") return el.active;
        else return !el.active;
    });
    missingTodos.forEach((todo)=>{
        const previousElement = Array.from((0, _todoDom.todoListElement).children).find((child)=>+child.dataset.id > todo.id);
        if (previousElement) {
            (0, _todoDom.todoListElement).insertBefore(createTodoElement(todo, initialRender), previousElement);
            return adjustListHeight();
        }
        (0, _todoDom.todoListElement).appendChild(createTodoElement(todo, initialRender));
        return adjustListHeight();
    });
};
const adjustListHeight = function() {
    requestAnimationFrame(()=>{
        let totalHeight = 0;
        Array.from((0, _todoDom.todoListElement).children).forEach((child)=>{
            const elHeight = child.getBoundingClientRect().height;
            totalHeight += elHeight;
        });
        (0, _todoDom.todoListElement).style.height = `${totalHeight}px`;
    });
};
const animateInitialTodoLoad = function() {
    return (0, _gsapDefault.default).fromTo("li", {
        opacity: 0,
        y: -20
    }, {
        opacity: 1,
...
const removeButtonsActive = function() {
    (0, _todoDom.controlButtons).forEach((btn)=>{
        btn.classList.remove("todo__controls-btn--active");
        btn.setAttribute("aria-pressed", "false");
    });
};

},{"gsap":"fPSuC","./todoDom":"l3eyk","./storage":"g091k","../images/icon-cross.svg":"fTEj8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g091k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initializeStorage", ()=>initializeStorage);
parcelHelpers.export(exports, "updateFilterState", ()=>updateFilterState);
parcelHelpers.export(exports, "updateTodoState", ()=>updateTodoState);
parcelHelpers.export(exports, "updateDarkMode", ()=>updateDarkMode);
...
const initializeStorage = function() {
    ...
    if (!localStorage.getItem("state")) localStorage.setItem("state", JSON.stringify(state));
};
const updateFilterState = function(filterType) {
...
const updateTodoState = function(newState) {
    const oldState = JSON.parse(localStorage.getItem("state"));
    localStorage.setItem("state", JSON.stringify({
        ...oldState,
        todos: newState
...
const updateDarkMode = function(darkMode) {
    const oldState = JSON.parse(localStorage.getItem("state"));
    localStorage.setItem("state", JSON.stringify({
        ...oldState,
        darkMode: darkMode
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fTEj8":[function(require,module,exports) {
module.exports = require("37f791802fff17a0").getBundleURL("jcUGk") + "icon-cross.4105108f.svg" + "?" + Date.now();

},{"37f791802fff17a0":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6xyKm":[function(require,module,exports) {
module.exports = require("73000bec5d04517d").getBundleURL("jcUGk") + "icon-sun.a3e79264.svg" + "?" + Date.now();

},{"73000bec5d04517d":"lgJ39"}],"5qRnu":[function(require,module,exports) {
module.exports = require("acec535df0472b58").getBundleURL("jcUGk") + "icon-moon.414448a4.svg" + "?" + Date.now();

},{"acec535df0472b58":"lgJ39"}],"knUSZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleTodoClick", ()=>handleTodoClick);
...
const markTodo = function(e, originalId) {
    ...
    if (e.target.type === "checkbox") {
        const newState1 = state.todos.map((todo)=>todo.originalId === originalId ? {
                ...todo,
                status: todo.status === "active" ? "completed" : "active"
            } : todo);
        const todo = state.todos.find((todo)=>todo.originalId === originalId);
        const todoElement = e.target.closest("li");
        (0, _storage.updateTodoState)(newState1);
        e.target.toggleAttribute("checked");
        todoElement.classList.toggle("todo__item--done");
        todoElement.setAttribute("data-status", todoElement.getAttribute("data-status") === "completed" ? "active" : "completed");
        (0, _todoDomUtils.countTodos)();
        if (state.appliedFilter !== "all") (0, _todoDomUtils.removeTodoElements)(todoElement);
    }
};
const removeTodo = function(e, originalId) {
    ...
    if (e.target.closest(".todo__btn-delete")) {
        ...
        const todoElement = e.target.closest("li");
        (0, _todoDomUtils.removeTodoElements)(todoElement);
    }
};
const handleTodoClick = function(e) {
...
const handleFormSubmit = function(e) {
    e.preventDefault();
    const userInput = (0, _todoDom.todoInputElement).value.trim();
    const state = (0, _storage.getState)();
    if (!userInput) {
        if (errorTimeout) clearTimeout(errorTimeout);
        (0, _todoDom.todoFormElement).classList.add("todo__form--error");
        errorTimeout = setInterval(()=>(0, _todoDom.todoFormElement).classList.remove("todo__form--error"), 3000);
        return new (0, _notyf.Notyf)({
            position: {
                x: "right",
                y: "top"
            }
    ...
    const description = (0, _dompurifyDefault.default).sanitize(userInput, {
    ...
    (0, _storage.updateTodoState)(newState);
    if (state.appliedFilter !== "completed") (0, _todoDom.todoListElement).appendChild((0, _todoDomUtils.createTodoElement)(newTodo));
    (0, _todoDomUtils.adjustListHeight)();
    new (0, _notyf.Notyf)({
        position: {
            x: "right",
    ...
    (0, _todoDomUtils.countTodos)();
    (0, _todoDom.todoInputElement).value = "";
};

},{"./storage":"g091k","./todoDomUtils":"5iDqy","./todoDom":"l3eyk","dompurify":"9Kzno","uuid":"j4KJi","notyf":"2LIPM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Kzno":[function(require,module,exports) {
...
},{}],"2LIPM":[function(require,module,exports) {
/*! *****************************************************************************
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bNdHE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initializeControls", ()=>initializeControls);
var _storage = require("./storage");
var _todoDomUtils = require("./todoDomUtils");
var _todoDom = require("./todoDom");
var _todoFilter = require("./todoFilter");
const initializeControls = function() {
    (0, _todoDom.allButtonElement).addEventListener("click", function() {
        const state = (0, _storage.getState)();
        if (state.appliedFilter === "all") return;
        (0, _storage.updateFilterState)("all");
        (0, _todoFilter.renderTodosByFilter)("all");
    });
    (0, _todoDom.activeButtonElement).addEventListener("click", function() {
        const state = (0, _storage.getState)();
        if (state.appliedFilter === "active") return;
        (0, _storage.updateFilterState)("active");
        (0, _todoFilter.renderTodosByFilter)("active");
    });
    (0, _todoDom.completedButtonElement).addEventListener("click", function() {
        const state = (0, _storage.getState)();
        if (state.appliedFilter === "completed") return;
        (0, _storage.updateFilterState)("completed");
        (0, _todoFilter.renderTodosByFilter)("completed");
    });
    (0, _todoDom.clearButtonElement).addEventListener("click", function() {
        const state = (0, _storage.getState)();
...
},{"./storage":"g091k","./todoDomUtils":"5iDqy","./todoDom":"l3eyk","./todoFilter":"8XoUO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8XoUO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderTodosByFilter", ()=>renderTodosByFilter);
var _todoDom = require("./todoDom");
var _todoDomUtils = require("./todoDomUtils");
const renderTodosByFilter = function(filterType, initialRender = false) {
    const filterButton = Array.from((0, _todoDom.controlButtons)).find((el)=>filterType === el.dataset.filterType);
    const filteredItems = Array.from((0, _todoDom.todoListElement).children).filter((el)=>el.dataset.status !== filterType);
    const dragText = filterType === "all" ? "Drag and drop to reorder list" : "Drag and drop is disabled in this view";
    (0, _todoDomUtils.addMissingTodos)(initialRender);
    if (filterType !== "all") {
        (0, _todoDomUtils.removeTodoElements)(filteredItems);
        (0, _todoDom.todoListElement).classList.add("todo__filtered");
        (0, _todoDom.sortable).option("disabled", true);
    }
    if (filterType === "all") {
        (0, _todoDom.todoListElement).classList.remove("todo__filtered");
        (0, _todoDom.sortable).option("disabled", false);
    }
    (0, _todoDomUtils.countTodos)();
    (0, _todoDom.dragTextInfoElement).textContent = dragText;
    (0, _todoDomUtils.removeButtonsActive)();
    filterButton.classList.add("todo__controls-btn--active");
    filterButton.setAttribute("aria-pressed", true);
};

},{"./todoDom":"l3eyk","./todoDomUtils":"5iDqy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bpCRw":[function() {},{}]},["6Cziv","ahc7M"], "ahc7M", "parcelRequire5af9")
